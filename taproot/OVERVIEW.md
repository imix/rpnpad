...
<!-- Last updated: 2026-03-25 (sweep: promote 12 behaviours specified→implemented) -->
...
- **[direct-common-functions](./discoverability/direct-common-functions/usecase.md)** `[implemented]` — Actor: User (CLI power user)
  - [tui](./discoverability/direct-common-functions/tui/impl.md) `[complete]` (2 commits, 16 tests)

...
impl CalcValue {
    pub fn to_f64(&self) -> f64 {
        match self {
            ...
            CalcValue::Tagged(t) => t.amount.to_f64().value(),
        }
    }
    ...
    pub fn display_with_precision(&self, base: Base, precision: usize) -> String {
        match self {
            ...
            CalcValue::Tagged(t) => format!("{} {}", format_fbig_prec(&t.amount, precision), t.unit),
        }
    }
    ...
    pub fn display_with_notation(&self, base: Base, precision: usize, notation: Notation) -> String {
        match self {
            CalcValue::Tagged(t) => {
                ...
                let numeric = format_fbig_notation(&t.amount, precision, notation);
